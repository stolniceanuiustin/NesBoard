...
module design_1
  ...
  wire hsync_0;
  wire pixel_clock_generator_locked;
  ...
  wire [15:0]vga_fetcher_0_addrb;
  wire vga_fetcher_0_enb;
  wire [11:0]video_signal_0_Hpos;
  wire [11:0]video_signal_0_Vpos;
  wire video_signal_0_ok_video;
  wire vsync_0;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra(axi_bram_ctrl_0_BRAM_PORTA_ADDR[13:0]),
        .addrb(vga_fetcher_0_addrb),
        ...
        .enb(vga_fetcher_0_enb),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE[0]),
        .web(xlconstant_0_dout[0]));
  design_1_clk_wiz_0_0 pixel_clock_generator
       (.clk_in1(processing_system7_0_FCLK_CLK0),
        .clk_out1(clk_wiz_0_clk_out1),
        .locked(pixel_clock_generator_locked),
        .reset(reset_rtl_0));
  design_1_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(pixel_clock_generator_locked),
  ...
  design_1_vga_fetcher_0_0 vga_fetcher_0
       (.B(B_0),
        .G(G_0),
        .R(R_0),
        .addrb(vga_fetcher_0_addrb),
        .doutb(blk_mem_gen_0_doutb),
        .enb(vga_fetcher_0_enb),
        .hpos(video_signal_0_Vpos),
        .ok_video(video_signal_0_ok_video),
        .pclk(clk_wiz_0_clk_out1),
        .vpos(video_signal_0_Hpos));
  design_1_video_signal_0_0 video_signal_0
       (.CLK(clk_wiz_0_clk_out1),
        .Enable(xlconstant_1_dout),
        .Hpos(video_signal_0_Hpos),
        .Rst(proc_sys_reset_0_peripheral_reset),
        .Vpos(video_signal_0_Vpos),
        .hsync(hsync_0),
        .ok_video(video_signal_0_ok_video),
        .vsync(vsync_0));
