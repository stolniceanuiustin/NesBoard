...
HD_PWD='C:/Users/IStolnic/Licenta/NesBoard/NesBoard.runs/design_1_vga_fetcher_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vga_fetcher_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vga_fetcher_0_0.tcl
